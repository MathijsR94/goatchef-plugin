...
function gc_show_products($attrs, $content)
{
  ...
  <div class="bounce3"></div>
    ...
    <div class="homepage-products hidden">
        <ol class="steps">
            <li class="steps__item steps__item--first steps__item--done steps__item--active" data-progress-step="breakfast"><a href="#" class="steps__link">Ontbijt</a></li>
...
foreach ($recipes as $recipe) {
    ...
    ?>
            ...
            <div id="end" class="hidden">
                <div class="notify">
                <div class="notify__message"><span class="bold">Klaar!&nbsp;</span><span>Maak nu eenvoudig een boodschappenlijst aan of doe direct jouw boodschappen online.</div>
 ...
 <g>
  ...
  <path d="M392.7 29.7a101.7 101.7 0 0 0-143.6 0A10 10 0 1 0 263.2 44a81.7 81.7 0 0 1 115.4 0c2 2 4.5 3 7 3s5.2-1 7.1-3a10 10 0 0 0 0-14.2zM328 94.7a10 10 0 0 0-14.2 0 10 10 0 0 0 0 14.2 10 10 0 0 0 14.2 0 10 10 0 0 0 0-14.2z"/>
        ...
        <div class="card__detail hidden">
                <p class="card__title"><?php echo $recipe->recipe_title ?></p>
                <ul>
                    <?php foreach ($recipe->nutrition as $nutrition): ?>
                    <li><?php echo $nutrition->name . ' ' . $nutrition->value . ' ' . $nutrition->unit; ?></li>
<?php endforeach;?>
                </ul>
